...
```bash
# Elasticsearch takes time to start (up to 60 seconds)
curl http://localhost:9200/_cluster/health
```

**CORS errors in frontend:**
```bash
# Restart API container to apply CORS settings
...
- Angular lazy loading for larger apps
- API response caching
- Image optimization for Docker containers
